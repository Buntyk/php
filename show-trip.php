...
<html>
    ...
    <!-- Main body part  -->
            ...
            <!-- Click button to check availability-->
                   ...
                   <h1 >OUR DESTINATIONS<hr width="900"></hr></h1></div>
                        ...
                        <table align="center" cellspacing="15">
                          <tr >
                            ...
                            <td align="center"><div class="manali-back"><div class="box"><h1 style="background-color:powderblue" class="heading" ><?php print $_SESSION['destination']; ?></h1><h2><?php echo "Date".": ". $_SESSION['fromdate']; ?></h2>
                                                  ...
                                                  <span style="background-color:orange;" class="heading"><?php echo $_SESSION['remarks']; ?></span><br><br><br>
